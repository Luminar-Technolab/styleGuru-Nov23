  ...
  proceedToBuy(){
    if(this.checkoutForm.valid){
      ...
      if(sessionStorage.getItem("cartTotal")){
        this.totalAmout = sessionStorage.getItem("cartTotal") || ""
        this.initConfig()
      }
    }else{
    ...
    this.payPalConfig = {
        ...
        onClientAuthorization: (data) => {
          ...
          this.api.emptyCartAPI().subscribe((res:any)=>{
            ...
            this.toaster.success("Successfully completed the payment... Thank you fro purchasing with us!!!")
